...
namespace UserManagementWithIdentity.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            //This line indicate if the guest tryies to login with email or with username , if guest tries to login with email, username variable will recieve username. 
